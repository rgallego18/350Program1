  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  3a:	e8 ec 02 00 00       	call   32b <exit2>
  3f:	90                   	nop
 ...
 348:	89 d1                	mov    %edx,%ecx
{
 ...
 37b:	0f b6 92 a8 07 00 00 	movzbl 0x7a8(%edx),%edx
 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 454:	ff 24 85 50 07 00 00 	jmp    *0x750(,%eax,4)
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 49 07 00 00       	mov    $0x749,%ebx
 ...
 591:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 607:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60a:	89 15 44 0a 00 00    	mov    %edx,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 44 0a 00 00    	mov    0xa44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	39 05 44 0a 00 00    	cmp    %eax,0xa44
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 44 0a 00 00    	mov    0xa44,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 48 0a 00 00       	mov    $0xa48,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 6f0:	00 00 00 
    if(p->s.size >= nunits){
