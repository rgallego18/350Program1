...
free(void *ap)
{
 ...
 5a1:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 617:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61a:	89 15 54 0a 00 00    	mov    %edx,0xa54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 54 0a 00 00    	mov    0xa54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	39 05 54 0a 00 00    	cmp    %eax,0xa54
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 54 0a 00 00    	mov    0xa54,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 58 0a 00 00       	mov    $0xa58,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 700:	00 00 00 
    if(p->s.size >= nunits){
