 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 39b:	0f b6 92 bc 07 00 00 	movzbl 0x7bc(%edx),%edx
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 474:	ff 24 85 64 07 00 00 	jmp    *0x764(,%eax,4)
 ...
 5b1:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 627:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62a:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68b:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
